...
export function BookingWizard({
  ...
  const body = (
    <div className={mode === "page" ? "mx-auto w-full max-w-2xl" : ""}>
      ...
      {step !== "success" && (
        <div className="sticky bottom-0 z-10 flex flex-wrap-reverse items-center justify-between gap-3 border-t border-[var(--line)] bg-white px-4 py-3 pb-[calc(.75rem+env(safe-area-inset-bottom,0px))] sm:px-5 sm:py-4">
          <Button
            type="button"
            variant="ghost"
